...
A bonus project from my Data Structures course. I wanted to actually understand how search engines work under the hood, so I built an inverted index from scratch using an open-addressing hash table with linear probing. No libraries — just C++.
